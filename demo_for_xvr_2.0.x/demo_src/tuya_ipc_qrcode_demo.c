...
void ty_qrcode_active_shorturl_get_cb(OUT CONST CHAR_T *shorturl )
{
    if(shorturl)
    {
      printf("ty_qrcode_active_shorturl_get_cb short url  is %s\n",shorturl);
    }
    else
    {
        printf("ty_qrcode_active_shorturl_get_cb short url  is null\n");
    }
   return ;
}
